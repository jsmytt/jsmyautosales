# Generated by Django 2.1.4 on 2018-12-31 23:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('New', 'New Vehicle'), ('Used', 'Used Vehicle'), ('Lease', 'Lease Vehicle'), ('faq', 'FAQ')], default='New', max_length=25, verbose_name='Listing Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(default='car', on_delete=django.db.models.deletion.CASCADE, to='listing.Car')),
            ],
        ),
    ]
